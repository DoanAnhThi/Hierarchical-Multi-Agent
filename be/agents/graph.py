...
class MultiAgentGraph:
    ...
    def _build_graph(self) -> StateGraph:
        ...
        workflow.add_node("synthesis_agent", self._synthesis_node)

        # Define edges
        workflow.set_entry_point("strategy_agent")
        workflow.add_edge("strategy_agent", "planning_agent")
        workflow.add_edge("planning_agent", "execution_agent")
        workflow.add_edge("execution_agent", "synthesis_agent")
